...
public class AdditionQuiz
{
    ...
    #region Intro
        ...
        Console.WriteLine("First let's go through the Division Tables");
    ...
    #region Seed the Arrays
        ...
        for (int hCounter = 0; hCounter < ArraySize; hCounter++)
        {
            ...
            {  //  0000000000, 1111111111, 222... etc.
                Multiplicands[iCounter] = hCounter;
            }
        }

        for (int hCounter = 0; hCounter < ArraySize; hCounter++)
        {   // 0123456789, 0123456789, 0123... etc.
    ...
    #region Shuffle Loosely
        ...
        #region Remove Divide by Zero // ( Strictly a no-no )
    ...
    #region Division Quiz
        ...
        StartHere:
            Console.Write("\n{0} \\ {1} = ",
                Multiplicands[myQueue[jCounter]] * Multiplyers[myQueue[jCounter]], Multiplicands[myQueue[jCounter]]);
            ...
            if (UserAnswer == (Multiplyers[myQueue[jCounter]]))
    ...
    #region Print Reaction Times
        ...
        Multiplicands[myQueue[iCounter]] * Multiplyers[myQueue[iCounter]], Multiplicands[myQueue[iCounter]], MultiTable[Multiplicands[myQueue[iCounter]], Multiplyers[myQueue[iCounter]]]);
        }
        #endregion
    ...
    #region Remove the Easy Questions
            ...
            StartHere2:
                Console.Write("\n\n{0} \\ {1} = ",
                    Multiplicands[myQueue[iCounter]] * Multiplyers[myQueue[iCounter]], Multiplicands[myQueue[iCounter]]);
                ...
                if (UserAnswer == (Multiplyers[myQueue[iCounter]]))
                {
            ...
            #endregion // end Retry Division Tables 
        }

    #region The End
                SystemSounds.Asterisk.Play();
                Console.WriteLine("\nYou have succesfully beat all of your intial slower reaction times! :)");
